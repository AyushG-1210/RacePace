...
>### Notes:<br>
>- Focusing on 1 driver strategy, as it's not feasible to find Global Nash Equilibrium for all drivers in a race.
...
>- Adpative Batching (100 cars for 2s simultaneously) to speed up training. Switched from 1000 cars for 0.1s model due to inability to learn gradual braking in corners.
>- Kamm's Circle models the grip and friction. Model was cheating by allocating 100x more grip than possible, so I added a penalty term to the loss function to prevent this.